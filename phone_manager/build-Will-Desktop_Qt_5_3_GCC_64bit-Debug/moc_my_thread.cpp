...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_My_Thread_t, stringdata) + ofs \
...
const QMetaObject My_Thread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_My_Thread.data,
      qt_meta_data_My_Thread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_My_Thread.stringdata))
