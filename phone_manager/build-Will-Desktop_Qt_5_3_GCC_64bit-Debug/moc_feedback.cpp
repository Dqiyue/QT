...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FeedBack_t, stringdata) + ofs \
...
const QMetaObject FeedBack::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FeedBack.data,
      qt_meta_data_FeedBack,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FeedBack.stringdata))
