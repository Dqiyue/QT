...
QT_MOC_LITERAL(4, 31, 11)
    ...
    "Thread\0emitSignal\0\0timerSignal\0"
    "changeValue"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->timerSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::emitSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (Thread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::timerSignal)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Thread::emitSignal(QString _t1)
{
...
// SIGNAL 1
void Thread::timerSignal(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
