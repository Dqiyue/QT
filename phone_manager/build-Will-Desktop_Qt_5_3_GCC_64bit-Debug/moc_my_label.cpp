...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_My_Label_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 31, 5)
    ...
    "My_Label\0clicked\0\0show_clicked\0judge"
};
...
void My_Label::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->show_clicked(); break;
        case 2: _t->judge((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (My_Label::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&My_Label::show_clicked)) {
                *result = 1;
            }
        }
        {
            typedef void (My_Label::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&My_Label::judge)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 1
void My_Label::show_clicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void My_Label::judge(QString _t1)
{
